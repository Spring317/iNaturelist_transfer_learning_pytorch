...
class MonteCarloSimulation:
    ...
    def _is_prediction_belongs_to_global_dataset(self, prediction: int) -> bool:
        ...
        if species_name not in self.global_species_names:
            return False

        return True


    def _translate_prediction_to_global_label(self, prediction: int):
        big_species_label = self.model_species_labels.get(prediction, None)
    ...
    def infer_with_routing(self, image_path: str, ground_truth: int):
        ...
        if result is None:
            ...
            return None
        if not self._is_prediction_belongs_to_global_dataset(result[0]):
        ...
        if big_species_name is None:
            ...
            return None
        global_pred = self._translate_prediction_to_global_label(result[0])
    ...
    def run(
        ...
        if save_path:
            ...
            with pd.option_context('display.max_rows', None, 'display.max_columns', None): 
                model_name = "convnext_full_bird_insect_accuracy_benchmark"
...
if __name__ == "__main__":
    ...
    pipeline.run(15, 1000, "./baseline_benchmark")