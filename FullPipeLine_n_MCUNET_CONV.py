...
if __name__ == "__main__":
    ...
    for i in range(0, 50, num_of_dominant_classes):
    ...
    small_model_paths = [
        f"models/mcunet-in2_haute_garonne_0.5_{i}_best.onnx" for i in range(0, 50, 7)
    ]
    ...
    print(f"big_species_labels: {big_species_labels}")
